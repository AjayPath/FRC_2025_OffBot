...
public class SimpleOdometry {
    ...
    private static SimpleOdometry instance;
    ...
    // Constructor
    private SimpleOdometry(List<MAXSwerveModule> swerveMods, Pigeon2 gyro) {
    ...
    public static SimpleOdometry getInstance(List<MAXSwerveModule> swerveMods, Pigeon2 gyro) {
        if (instance == null) {
            instance = new SimpleOdometry(swerveMods, gyro);
        }
        return instance;
    }
